...
export CODENAME=$(cat "${CONF}/$FOLDER/codename")-4.14
...
git clone --depth=1 -b $BRANCH https://${git_username}:$GIT_TOKEN@github.com/HANA-CI-Build-Project/msm-4.14.git saus
